...
<html>
    ...
    <div class="container">
        ...
        <section> 
            <form action="../verifica_placa_saida.php" method="post">
                <div class="form-group">
                    <label for="placa" >Placa do veículo</label>
                    <input type="text" class="form-control" name="placa" id="placa">
                    <input type="submit" class="btn btn-dark mt-2" value="Registrar saída">
                </div>
            </form>
            <a href="tela_controle.php" type="button" class="btn btn-dark mt-3">Voltar</a>
